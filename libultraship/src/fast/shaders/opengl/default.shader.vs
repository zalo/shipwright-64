...
// Previous-frame clip position (x, y, w) — always last so it doesn't shift
// the offsets of other attributes.
@{attr} vec3 aVtxPrevPos;
@{out} vec3 vPrevClipPos;
@{update_floats(3)}
